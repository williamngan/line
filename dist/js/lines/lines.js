...
var WalkSteps = (function (_Rectangle) {
  _inherits(WalkSteps, _Rectangle);

  function WalkSteps() {
    _classCallCheck(this, WalkSteps);

    for (var _len13 = arguments.length, args = Array(_len13), _key13 = 0; _key13 < _len13; _key13++) {
      args[_key13] = arguments[_key13];
    }

    _get(Object.getPrototypeOf(WalkSteps.prototype), "constructor", this).apply(this, args);
  ...
  _createClass(WalkSteps, [{
    key: "init",
    value: function init(space, viewport, steps) {
      this.space = space;
